...
plugins=(git sudo flutter adb 1password git-prompt swiftpm xcode
globalias)
...
# Important for initing homebrew with correct architecture
...
# For compilers to find java directly
